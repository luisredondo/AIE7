...
from ollama_deep_researcher.dnd_specialist import dnd_specialist_node, should_consult_dnd_specialist
...
def route_after_query(
...
) -> Literal["dnd_specialist", "web_research"]:
    """Route after query generation to check if D&D specialist should handle this.
    ...
    Returns:
        String literal indicating the next node ("dnd_specialist" or "web_research")
    """
    if should_consult_dnd_specialist(state, config):
        return "dnd_specialist"
    return "web_research"
...
builder.add_node("dnd_specialist", dnd_specialist_node)
builder.add_node("finalize_summary", finalize_summary)

# Add edges
builder.add_edge(START, "generate_query")
# After query generation, route to either D&D specialist or web research
builder.add_conditional_edges("generate_query", route_after_query)
# D&D specialist goes directly to finalize
builder.add_edge("dnd_specialist", "finalize_summary")
# Normal web research flow
